    ...
    <form class="mt-14 space-y-5" novalidate method="POST" action="{{ route('register.store') }}">
        ...
        <div class="space-y-2">
            ...
            <input id="email" type="email" placeholder="Email de Registro"
                class="w-full border border-gray-300 @error('email') border-red-600 @enderror p-3 rounded-lg" name="email"
        ...
        <div class="space-y-2">
            ...
            <input type="password" placeholder="Password de Registro"
                class="w-full border border-gray-300 @error('password') border-red-600 @enderror p-3 rounded-lg"
        ...
        <div class="space-y-2">
            ...
            <input type="password" placeholder="Password de Registro"
                class="w-full border border-gray-300 @error('password_confirmation') border-red-600 @enderror p-3 rounded-lg"
